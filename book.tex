...
\chapter{S\-o\-ß\-e\-n}
\thispagestyle{empty}
\include{rec_bechamel}
\include{rec_kaesesosse}
\include{rec_pistazienpesto}
\include{rec_veganemayo}
\chapter{S\-a\-l\-a\-t\-e}
\thispagestyle{empty}
\include{salate}
...
\thispagestyle{empty}
\include{rec_sauerteigbrot}
\include{rec_hefebrot}
\include{rec_marraqueta}
\include{rec_pizzaoelteig}
\include{rec_flammkuchen}
\include{rec_muerbeteig}
\include{rec_quiche}
\chapter{K\-u\-c\-h\-e\-n}
\thispagestyle{empty}
\include{kuchen}
